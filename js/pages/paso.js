        ...
        agrupaciones.forEach(agrupacion => {
            ...
            if (partidos) {
                partidos.forEach(partido => {
                    ...
                    p1Partido.textContent = partido.nombre;// agrega el nombre de la lista al <p>//

                    const spanP1Partido = document.createElement('span'); //crea el span donve va el porcentaje de votos//
                    const porcentajeVotos = `${(partido.votos * 100 / agrupacion.votos).toFixed(2)}%`; // calculo el porcentaje y hago que solo tenga 2 decimales//
                    ...
                    spanP2Partido.textContent = `${partido.votos} votos`; // formateo los votos para que se vean asi "XXX votos" //
